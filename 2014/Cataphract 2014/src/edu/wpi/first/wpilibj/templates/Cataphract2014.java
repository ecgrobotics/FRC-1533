  ...
  //  DigitalOutput out,light;
    ...
    public void teleopPeriodic() {
       ...
       // light.set(true);
        ...
        if(lstick.getRawButton(1)&& !pad.getRawButton(8)){
            tshoot.set(speed*2);
            bshoot.set(speed);
        }
        else{
        ...
        if(lstick.getRawButton(3) || (fire && System.currentTimeMillis()-last<delay)){
            flip.set(-.7);
        } else if(lstick.getRawButton(2) || (fire && System.currentTimeMillis()-last>delay)){
            flip.set(.7);
        } else {
            flip.set(0);
        }
        if(rstick.getRawButton(1)&&!pad.getRawButton(6)&&!pad.getRawButton(8)&&(!pad.getRawButton(3)&&!rstick.getRawButton(4)&&!rstick.getRawButton(5))){            
            if(!fire) {
                fire=true;
            }
        }
...
//            }
        if(fire && System.currentTimeMillis()-last>delay*2){
            fire=false;
        }
    }
